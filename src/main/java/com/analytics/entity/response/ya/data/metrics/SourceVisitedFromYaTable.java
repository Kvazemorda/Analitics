...
public class SourceVisitedFromYaTable {
    private QueryFromResponseYa query;
    private ArrayList<DimensionDataTableFormat> data;
    ...
    public SourceVisitedFromYaTable() {
    ...
    public ArrayList<DimensionDataTableFormat> getData() {
        return data;
    }

    public void setData(ArrayList<DimensionDataTableFormat> data) {
        this.data = data;
    }
